function FinalCTA() {
  return (
    <section
      id="contact"
      className="relative overflow-hidden bg-[#C8A24A] px-6 py-24 text-[#0B2E59] lg:px-8 lg:py-32"
    >
      {/* Decorative elements */}
      <div className="absolute -right-24 -top-24 h-72 w-72 rounded-full border border-[#0B2E59]/10" />
      <div className="absolute -bottom-32 -left-20 h-80 w-80 rounded-full border border-[#0B2E59]/10" />

      <div className="relative mx-auto max-w-7xl">
        <div className="max-w-4xl">
          <p className="text-sm font-semibold uppercase tracking-[0.22em] text-[#0B2E59]/60">
          ...
          <p className="mt-7 max-w-2xl text-lg leading-8 text-[#0B2E59]/65">
        ...
        <div className="mt-20 border-t border-[#0B2E59]/15 pt-6">
          <p className="text-sm text-[#0B2E59]/50">
